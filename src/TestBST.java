...
public class TestBST {
	...
	/* =================================================================== */
	private static void insertPoints(BufferedImage im, int xf, int yf, int xl, int yl, int width)
		...
		/*
		 * Perform a binary splitting of the set of pixels and insert them in that order
